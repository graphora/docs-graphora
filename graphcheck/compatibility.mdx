---
title: 'Neo4j Compatibility'
description: 'Tested Python, driver, server, and Cypher combinations and the support policy'
---

GraphCheck keeps the Python driver, Neo4j Server, and Cypher language versions separate. The
tested release matrix for GraphCheck 0.2 is:
...
Neo4j 4.4 is legacy and unsupported by GraphCheck 0.2. It is absent from CI, and the connector
