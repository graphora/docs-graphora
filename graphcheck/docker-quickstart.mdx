...
description: 'Run GraphCheck against a local Neo4j demo seeded with the fraud-ring fixture'
---
...
For general installation and project usage, see the [main README](https://github.com/graphora/graphcheck/blob/development/README.md).
...
separate follow-on workflow using [`examples/checks/example.yml`](https://github.com/graphora/graphcheck/blob/development/examples/checks/example.yml)
